...
full_branch_fu bfu:
	$(VERILATOR) --top-module test_full_branch_fu src/common/*.sv test/out_of_order/branch/full_branch_fu.sv src/out_of_order/branch/*.sv src/out_of_order/{instruction_route,cdb_arbiter,functional_unit_output_buffer,reorder_buffer,reservation_station}.sv
